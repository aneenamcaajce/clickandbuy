...
$sql="INSERT INTO `tbl_moderator`( `job`, `approval`) VALUES ('$job','$approval')";
print_r($sql);
$result=mysqli_query($con,$sql);
$sql1="INSERT INTO `tbl_login`(`userid`, `password`, `usertype`,`status`) VALUES ('$userid','$password','moderator',3)";
print_r($sql1);
...
<fieldset>
<legend>MODERATOR FORM</legend>
<table border="0" align="center">
<tr><td>JOB:</TD><TD><INPUT TYPE="TEXT" NAME="job"></td></tr>

<tr><td>APPROVAL:</TD><TD><INPUT TYPE="TEXT" NAME="approval"></td></tr>
