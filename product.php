...
$sql="INSERT INTO `tbl_product`(`name`,`brand`,`price`,`rating`,`description`,`image`) VALUES ('$name','$brand','$price','$rating','$description','$image')";
//echo $sql;
...
<form  name="skills" method="post" action=" " enctype="multipart/form-data">    
 <div align="center">
   <table align="center" width="200" border="1">
     ...
     <tr>
       <td colspan="2" align="center"><font color="black">product details</font></td>
